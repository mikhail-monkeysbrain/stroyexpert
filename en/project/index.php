...
<div style="border-top:1px solid #ccc;width:500%;margin-top:30px;margin-left: -200%;"></div>
			...
			<div class="profil_d_block_copy" style="">
				<div class="otstup">
					<div class="profd"  style="margin-right:0px;margin-bottom:17px;background-color:#08c;"><p style="font-size:13px;color:#fff;text-align:right;padding: 5px 20px 5px 0;">ПРОЕКТЫ</p></div>
			...
			<div class="news_block_pd">
							...
							<div style="width:29.2%;min-width:250px;background-color:#EBEDEC;padding:20px 20px 20px;">
								<div class="left-menu">
									<ul class="menu_services_right" style="">
										<li>
											<a class="services_number" href="/services/kompleksnoe-proektirovanie/" style="color:#8C8C8C;">Комплексное проектирование</a>
										</li>
										<li>
											<a class="services_number" href="/services/stroitelno-montazhnye-raboty/" style="color: rgb(140, 140, 140);">Строительно-монтажные работы</a>
										</li>
										<li>
											<a class="services_number" href="/services/slujba_gen_podrydchika/" style="color: rgb(140, 140, 140);">Служба генерального подрядчика</a>
										</li>
									</ul>
								</div>
							</div>
				...
				<div class="otstup">
					...
					<div class="news_r" style="margin-bottom:20px;background-color:#08c;margin-top:20px;"><p style="font-size:13px;color:#fff;text-align:right;padding:5px 20px 5px 0;">УСТОЙЧИВОЕ РАЗВИТИЕ</p></div>
						<div style="width:300%;background-color:#EBEDEC;box-shadow: 8px 2px 10px #424242;">
							<div style="width:29.2%;min-width:250px;background-color:#EBEDEC;padding:20px 20px 20px;">
								<div class="left-menu">
									<?$APPLICATION->IncludeComponent(
