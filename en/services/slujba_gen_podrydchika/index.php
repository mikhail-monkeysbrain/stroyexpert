...
<div style="border-top:1px solid #ccc;width:500%;margin-top:30px;margin-left: -200%;"></div>
			...
			<div class="profil_d_block_copy" style="">
				<div class="otstup">
					<div class="profd"  style="margin-right:0px;margin-bottom:16px;background-color:#0088CC;"><p style="font-size:12px;color:#fff;text-align:right;padding: 5px 20px 5px 0;">СЛУЖБА ГЕНЕРАЛЬНОГО ПОДРЯДЧИКА</p></div>
						<div style="margin-right:20px;"  align="justify">
							<div style="margin-bottom:15px;">
								<?$APPLICATION->IncludeComponent(
										...
										Array(
											"AREA_FILE_SHOW" => "page",
											"AREA_FILE_SUFFIX" => "zagolovok_index6",        // название включаемой области
											"EDIT_TEMPLATE" => ""
										)
								);?>
							</div>
				...
				<br>
				<a class="gen_podryad" href="/services/slujba_gen_podrydchika/gallery_project/">Посмотреть галерею проектов</a>
			...
			<div class="news_block_pd">
				<div class="otstup">
					...
					<div class="news_r" style="margin-bottom:20px;margin-top:20px;background-color:#08c;"><p style="font-size:13px;color:#fff;text-align:right;padding:5px 20px 5px 0;">НОВОСТИ</p></div>
