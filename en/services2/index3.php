...
<div style="border-top:1px solid #ccc;width:500%;margin-top:30px;margin-left: -200%;"></div>
			...
			<div class="profil_d_block_copy" style="">
				<div class="otstup">
					<div class="profd"  style="margin-right:0px;margin-bottom:30px;background-color:#878787;"><p style="font-size:13px;color:#fff;text-align:right;padding: 5px 20px 5px 0;">—“–Œ»“≈À‹ÕŒ ÃŒÕ“¿∆Õ€≈ –¿¡Œ“€</p></div>
					<?$APPLICATION->IncludeComponent(
	"bitrix:news", 
