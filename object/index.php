...
$APPLICATION->SetPageProperty("description", "Каталог выполненных работ по витражному остеклению, монтажу навесных фасадов, офисных перегородок, входных групп на данных объектах.");
$APPLICATION->SetPageProperty("title", "| Объекты");
...
?><div class="project_wrap2" style="width:100%;background-color:#fff;padding-top: 144px;">
	...
	Array(
		...
		<div class="profil_d_block_copy">
			<div class="otstup">
				<div class="profd" style="margin-bottom:20px;background-color:#878787;">
