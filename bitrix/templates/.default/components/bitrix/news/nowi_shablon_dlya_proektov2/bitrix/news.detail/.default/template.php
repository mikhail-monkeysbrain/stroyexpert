...
<!-- НАЗВАНИЕ И АДРЕС -->
	<p style="color: #424242;font-size: 12px;line-height: 1;text-transform: uppercase;margin-bottom:10px;"><?=$arResult['NAME']?></p>
	<p style="color: #424242;font-size: 12px;line-height: 1;margin-bottom:10px;"><?=$arResult['PROPERTIES']['adress']['VALUE']?></p>
...
<!-- /НАЗВАНИЕ И АДРЕС -->
	...
	<p class="text_big" style="line-height:1;font-size:12px;text-align: justify;margin-right:20px;color:#898989;"><?echo $arResult["DETAIL_TEXT"];?></p>
	<?else:?>
	<p class="text_big" style="line-height:1;font-size:12px;text-align: justify;margin-right:20px;color:#898989;"><?echo $arResult["PREVIEW_TEXT"];?></p>
	<?endif?>
	<div style="clear:both"></div>
	<br />
...
<!-- Стадия реализации проекта -->
	<p class="stadia_real" style="width: 100%;max-width: 195px;padding:8px 51px;color:#8C8C8C;text-transform: uppercase;position:absolute;left: 342px;top:25px;border-top:1px solid;border-bottom:1px solid;font-family:Century Gothic">
...
<div class="teh_opis" style="width:100%;background-color:#585858;margin:30px auto 2px;"><p style="color:#fff;font-size: 13px;padding: 5px 10px 5px 10px;">ТЕХНИКО - ЭКОНОМИЧЕСКИЕ ПОКАЗАТЕЛИ</p></div>
	...
	<?if(!empty($arResult['PROPERTIES']['flash_banner']['VALUE'])){ ?>
		<img style="max-width:156px;" src="<?=CFile::GetPath($arResult['PROPERTIES']['flash_banner']['VALUE']);?>">
...
<!-- Планировочные решения -->
	<?if ($arProperty['CODE']=='texniko'){?>
		<div style="width:100%;background-color:#585858;margin-bottom:20px;margin-top: 5px;"><p style="color:#fff;font-size: 13px;padding: 5px 10px 5px 10px;">ПЛАНИРОВОЧНЫЕ РЕШЕНИЯ</p></div>
...
<!-- ОПИСАНИЕ ПРОЕКТА -->
	...
	<div style="width:100%;background-color:#E9E8E8;margin-bottom:20px;margin-top: 5px;"><p style="color:#4F4C4D;font-size: 13px;padding: 5px 10px 5px 10px;">ОПИСАНИЕ ПРОЕКТА</p></div>

	<div style="margin-bottom: 10px;font: 20px Verdana,sans-serif;width: 50%;float:right;">
	...
	<p style="color:#898989;margin-bottom:10px;line-height: 1;"><?=$arResult['PROPERTIES']['konstructiv_zdania']['VALUE'][$z];?></p>
	<?};?><!--/for-->
