...
<div class="news-list new_class str_mont_rab">
...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="obshi" style="width:326px;float:left;margin-bottom:2px;"><!-- общий -->
	<div style="margin:0;padding:0;min-height:0px;border:none;" class="news-item prt" id="<?=$this->GetEditAreaId($arItem['ID']);?>"><!-- asd -->
		<?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?>
			<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>

		<a class="img_news float_style grow" style="position:relative;float:left;margin-right:2px;width:326px;height:180px;display:block;"  href="<?=$arItem["DETAIL_PAGE_URL"]?>">  <!-- картинка анонса -->
...
<!--////////////////////////////////// -->
			...
			<div class="proba3 <?=$y.$r?>" style="">

					<div class="proba_min_stm_proekti" style=""> <!-- дата -->
						<div class="serv_img arrow2_stm_proekti <?=$m.$n?>" style="text-align:center;margin-top:60px;margin-left:10px;">
