...
<script>
	   ...
	   $(".main_head").css("height",$(window).height());    //функция задает высоту блока = высоте окна браузера
	};
    heightDetect();
    $(window).resize(function(){	// при изменении размера окна браузера(resize) включается наша функция
        heightDetect()
})*/
...
<div class="teh_opis" style="width:100%;background-color:#878787;margin:20px auto 2px;"><p style="color:#fff;font-size: 13px;padding: 5px 10px 5px 10px;">ТЕХНИЧЕСКОЕ ОПИСАНИЕ</p></div>
...
<!-- Планировочные решения -->
	<?if ($arProperty['CODE']=='texniko'){?>
		<div style="width:100%;background-color:#585858;margin-bottom:30px;margin-top: 5px;"><p style="color:#fff;font-size: 13px;padding: 5px 10px 5px 10px;">ПЛАНИРОВОЧНЫЕ РЕШЕНИЯ</p></div>
