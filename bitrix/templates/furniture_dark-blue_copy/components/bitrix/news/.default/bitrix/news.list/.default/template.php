...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<p style="margin:0;padding:0;min-height:0px;border:none;" class="news-item prt" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		...
		<a class="img_news float_style" style="float:left;margin-right:2px;width:326px;"  href="<?=$arItem["DETAIL_PAGE_URL"]?>">  <!-- картинка анонса -->
...
?>
	...
	<div class="proba" style="width:326px;">
		...
		<a style="vertical-align: middle;display:table-cell;padding-left: 20px;padding-right: 20px;" href="<?echo $arItem["DETAIL_PAGE_URL"]?>">
			<b style="line-height: 1.4;font-size:13px;color:#424242;"><?echo $arItem["NAME"]?></b><br>
								...
								<?/*echo  $arItem["PREVIEW_TEXT"];*/?>
									...
									<?foreach($arItem["DISPLAY_PROPERTIES"] as $pid=>$arProperty):?>
										...
										<small style="font-size:85%;color:#424242;">
											<?/*=$arProperty["NAME"]*/?>
			...
			<span style="color:#008DD2;font-size:85%;">Посмотреть проект</span>
		</a><br />
	</div>
</div>
<div style="clear:both;"></div>
...
<p style="margin:0;padding:0;min-height:0px;border:none;" class="news-item prt" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
	...
	<a class="img_news float_style" style="width:326px;"   href="<?=$arItem["DETAIL_PAGE_URL"]?>">  <!-- картинка анонса -->
				<img style="width:326px;height:180px;"
						class="preview_picture image_news"
						border="0"
						src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>"
