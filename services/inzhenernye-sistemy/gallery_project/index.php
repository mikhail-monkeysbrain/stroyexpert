...
<div style="border-top:1px solid #ccc;width:500%;margin-top:30px;margin-left: -200%;"></div>
			...
			<div class="profil_d_block_copy" style="">
				<div class="otstup">
					<div class="profd"  style="margin-bottom:30px;background-color:#0088CC;"><p style="font-size:13px;color:#fff;text-align:right;padding: 5px 20px 5px 0;">СЛУЖБА ГЕНЕРАЛЬНОГО ПОДРЯДЧИКА</p></div>
						<?$APPLICATION->IncludeComponent(
	"bitrix:news", 
	...
	array(
		...
		"CHECK_DATES" => "Y",
		"SEF_MODE" => "Y",
		"SEF_FOLDER" => "/services/slujba_gen_podrydchika/gallery_project/",
		"AJAX_MODE" => "N",
		"AJAX_OPTION_JUMP" => "N",
		"AJAX_OPTION_STYLE" => "Y",
	...
	false
				...
				<!-- толстая линия снизу -->
				<div class="line_bold" style="background-color:#0088CC;"></div>
				<!-- /толстая линия снизу -->
				<?}?>
