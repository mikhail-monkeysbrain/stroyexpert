...
$APPLICATION->SetPageProperty("description", "Услуги по проведению экспертизы объектов капитального строительства, проектно- сметной документации, экспертизы инженерных изысканий");
$APPLICATION->SetPageProperty("keywords", "негосударственная экспертиза, негосударственная экспертиза проектно сметной документации, негосударственная экспертиза проектной документации, негосударственная экспертиза проектов, независимая экспертиза вологда, оценка проектной документации, проверка проектной документации на соответствие, проектная экспертиза, проектно-сметная документация в вологде, соответствие проектной документации, экспертиза проектно сметной документации, экспертиза проектной документации, экспертиза сметной документации");
$APPLICATION->SetPageProperty("title", "| Услуги | Экспертиза проектной документации");
$APPLICATION->SetTitle("Экспертиза проектной документации");
?>
...
<div class="line_zagran" style="border-top:1px solid #ccc;width:500%;margin-top:30px;margin-left: -200%;"></div>
			...
			<div class="profil_d_block_copy" style="">
				<div class="otstup">
					<div class="profd"  style="margin-bottom:17px;background-color:#5E969F;"><p style="font-size:12px;color:#fff;text-align:right;padding: 5px 20px 5px 0;">ЭКСПЕРТИЗА ПРОЕКТНОЙ ДОКУМЕНТАЦИИ</p></div>
