...
if (!empty($name)  && !empty($mail) && !empty($phone)) //если все переменные имеют значения выполняем запись в файл
    {
						...
						$to = "info@stroyexpert.pro"; // E-mail получателя vokayleb1@gmail.com //info@stroyexpert.pro
						...
						if(!empty($file))
						{
						  ...
						  $maxsize = "10000000";
						  $extentions = array( "gif","txt","jpg","png","zip", "rar","psd","flv","doc","docx","xls","xlsx","ppt");
